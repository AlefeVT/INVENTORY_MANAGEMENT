                ...
                <div className="grid max-w-[1300px] mx-auto gap-4 px-4 sm:px-6 md:px-10 md:grid-cols-2 md:gap-16 mb-20">
                    <div>
                        ...
                        <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                            Gerencie seu estoque com facilidade e tenha uma visão clara do seu comercio.
                        </p>
                    ...
                    <div className="flex flex-col items-start space-y-4">
                        ...
                        <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                            Tenha uma visão clara do seu estoque e tome melhores decisões sobre seu comercio.
                        </p>
                    </div>
                </div>
            </div>
